...
public class RestaurantRepositoryServiceImpl implements RestaurantRepositoryService {
  ...
  // int noOfRestaurantsToResponse = 0;

  // public boolean setRestaurantSizeLimitTo50() {
  //   noOfRestaurantsToResponse++;
  //   return noOfRestaurantsToResponse >= 50;
  // }
